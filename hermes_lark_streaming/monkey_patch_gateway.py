...
def _inject_time_prefix(user_message: str | None, persist_user_message: str | None) -> tuple[str | None, str | None]:
    ...
    # Lazy imports from monkey_patch for test-mock compatibility.
    ...
    from .monkey_patch import _get_config, datetime, timezone, timedelta  # noqa: F811
...
def _wrap_run_conversation(orig: Callable) -> Callable:
    ...
    from .monkey_patch_callbacks import _maybe_wrap_callbacks  # noqa: F811
