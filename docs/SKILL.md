...
| 会话列表永久显示"处理中..." | `close_streaming` 是否传入 `summary` 参数 + `_streaming_closed` 守卫 | feishu/client.py, controller/linear_mixin.py |
