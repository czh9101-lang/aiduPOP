...
| 会话列表永久显示"处理中..." | `close_streaming` 是否传入 `summary` + `i18n_content` 是否同时更新 + `_streaming_closed` 守卫 | feishu/client.py, cardkit/cards.py, controller/linear_mixin.py |
